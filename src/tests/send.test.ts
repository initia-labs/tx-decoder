...
describe("Send Message", () => {
  it("should decode a simple send message with one coin correctly", () => {
    ...
    if (message.action === "send") {
      ...
      expect(message.data.coins[0].amount === "1000000").toBe(true);
      expect(message.data.coins[0].denom === "uinit").toBe(true);
    }
  ...
  it("should decode a simple send message with multiple coins correctly", () => {
    ...
    if (message.action === "send") {
      ...
      expect(message.data.coins[0].amount === "1000000").toBe(true);
      expect(message.data.coins[0].denom === "uinit").toBe(true);
      expect(message.data.coins[1].amount === "50000").toBe(true);
      expect(message.data.coins[1].denom === "uatom").toBe(true);
    }
